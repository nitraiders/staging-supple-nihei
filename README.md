...
KoKoRoMi Health & Beauty Project の静的ブランド / 商品紹介サイトです。健康食品・美容関連商品の企画販売を行う新規プロジェクトとして、KoKoRoMi の情報と販売準備状況を掲載します。

株式会社二信興業は、本プロジェクトの運営母体として控えめに表記します。二信興業本体の建築・型枠解体業の公式サイトと混同されないよう、サイト全体の主語は `KoKoRoMi` または `KoKoRoMi Health & Beauty Project` に統一します。
...
- `public/js/site-data.js`: ブランド名、運営母体、商品名、お知らせなどの共通データ
